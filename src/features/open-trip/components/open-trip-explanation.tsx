...
const benefits = [
  ...
  {
    icon: Users,
    title: "Bertemu Traveler Baru",
    description:
      "Berpetualang bersama sesama traveler Indonesia dan bangun pertemanan baru.",
  },
  {
    icon: Sparkles,
    title: "Sudah All-Inclusive",
    description:
      "Tiket pesawat, hotel, transport, makan halal, dan tour guide sudah termasuk dalam harga.",
  },
]
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              Open trip adalah perjalanan wisata grup dengan jadwal dan rute
              sudah ditentukan. Anda bergabung bersama traveler lain, dipandu
              tour guide berpengalaman. Tinggal pilih tanggal, berangkat!
            </p>
